...
<body>
	...
	<div class="page">
			<ul>
				<c:forEach items="${requestScope.muscleList }" var="muscle">
					<div class="m-show">
						<li class="m-img"><img alt="图片丢失" src="/static/imgs/muscle/${muscle.muscleImg }"></li>
						<li class="m-text"><a href="/muscle/toShowTheMuscle?muscleId=${muscle.muscleId }">${muscle.muscleName }</a></li>
					</div>
				</c:forEach>
			</ul>
	</div>
