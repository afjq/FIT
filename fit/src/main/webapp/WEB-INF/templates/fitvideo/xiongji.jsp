...
<body>
	...
	<div class="videoList">
		<div class="videoshow">
			<br> <img
				src="/imgs/muscle/40d3a3e7c7b4ec7c9567432abd8c3385.jpg"
				style="width: 270px; height: 250px; align: center;"> <br>
			<div class="a1">
				<p><a href="http://localhost:8080/web/xiongjivideo" style="text-decoration:none; color:#808080;">健身球高位俯卧撑</a></p>
			</div>
		</div>

		<div class="videoshow">
			<br> <img
				src="/imgs/muscle/20160510_5065d5776b468e7018a334ad26690642.jpg"
				style="width: 270px; height: 250px; align: center;"> <br>
			<div class="a1">
		...
		<div class="videoshow">
			<br> <img
				src="/imgs/muscle/2b1f329097f77725709be3a11255a0fd.jpg"
				style="width: 270px; height: 250px; align: center;"> <br>
			<div class="a1">
	...
	<div class="videoList">
		<div class="videoshow">
			<br> <img
				src="/imgs/muscle/533eabece6cc184268121cafc7cb6873.jpg"
				style="width: 270px; height: 250px; align: center;"> <br>
			<div class="a1">
				<p><a href="#" style="text-decoration:none;color:#808080;">仰卧窄握高位直杆弯举</a></p>
			</div>
		...
		<div class="videoshow">
			<br> <img
				src="/imgs/muscle/9fb040b2209f9244552c7b79a31d794f.jpg"
				style="width: 270px; height: 250px; align: center;"> <br>
			<div class="a1">
				<p><a href="#" style="text-decoration:none;color:#808080;">仰卧窄握高位直杆弯举</a></p>
			</div>
		...
		<div class="videoshow">
			<br> <img
				src="/imgs/muscle/ef0affd18cb13a456a348915d5b87167.jpg"
				style="width: 270px; height: 250px; align: center;"> <br>
			<div class="a1">
				<p><a href="#" style="text-decoration:none;color:#808080;">仰卧窄握高位直杆弯举</a></p>
			</div>
