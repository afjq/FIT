...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="${pageContext.request.contextPath}/alipay/pay" method=post
			target="_blank">
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" value="${requestScope.orderId }"/>
					</dd>
					<hr class="one_line">
					<dt>订单号 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="${requestScope.orderId }"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" name="WIDtotal_amount" value="${requestScope.price}"/>
					</dd>
					<hr class="one_line">
					<dt>商品描述：</dt>
					<dd>
